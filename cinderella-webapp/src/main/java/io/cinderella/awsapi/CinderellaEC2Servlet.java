...
public class CinderellaEC2Servlet extends HttpServlet {
   private static final long serialVersionUID = 3254509677670116952L;
   ...
   private static boolean isEC2APIEnabled = true;
